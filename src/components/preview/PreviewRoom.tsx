      ...
      <div className={`flex-1 flex overflow-hidden relative z-10 w-full min-h-[0]`}>
        <div className={`flex-1 relative flex flex-col items-center justify-center min-w-[0] ${isFrameless ? '' : 'p-4 lg:p-10'} `}>
            <div className={`w-full ${isFrameless ? 'h-full' : 'aspect-[16/9] h-auto max-w-full max-h-full'} relative flex flex-col group ${isFrameless ? '' : 'shadow-[8px_8px_0_0_rgba(0,0,0,1)] border-2 border-black bg-white'} overflow-hidden`}>
              ...
              {showSubtitles && currentSlide.id !== 'founder-note' && currentSlide.id !== 'vc-feedback' && (
                <div className="bg-black border-t-2 border-black flex flex-col items-center justify-center px-6 md:px-12 shrink-0 relative py-4">
                   <div className="w-full max-w-4xl bg-transparent text-white font-sans text-sm md:text-lg leading-relaxed text-center min-h-[64px] flex items-center justify-center whitespace-pre-wrap">
                      {currentSlide.content}
                   </div>
                </div>
              )}
